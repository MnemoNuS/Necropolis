...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		gridDifference		: 150,	//to make the grid blocks slower than the slices, this value must be smaller than transPeriod
		
		height				: '44.87%',	//here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'
